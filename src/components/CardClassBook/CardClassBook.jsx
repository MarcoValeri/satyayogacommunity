    ...
    return (
        <div className="card-class-book">
            <div className="card-class-book__container-info">
                ...
                <p className="card-class-book__time">{formatTime(props.time)} ({props.duration})</p>
            </div>
            <div className="card-class-book__container-data">
                <p className="card-class-book__title">{props.title}</p>
                <p className="card-class-book__teacher">{props.teacher && <a href={props.teacherLink} target="_blank"><GrFormNextLink className="card-class-book__map-icon" /></a>} {props.teacher}</p>
